...
public class MongoRecommendations {
    ...
    private static final MongoCollection<org.bson.Document> docRecommendations = db.getCollection("recommendations");
	...
	public static org.bson.Document recommendation(String idResearcher, List<String> researchers){
		...
		org.bson.Document document = new org.bson.Document("idResearcher", idResearcher)
