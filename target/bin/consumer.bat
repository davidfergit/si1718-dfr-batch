...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="consumer" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" data.streaming.test.TestFlinkKafkaConsumer %CMD_LINE_ARGS%
